    ...
    <div className="student-portfolio-layout">
      <section className="panel student-portfolio-main">
        <div className="panel-heading">
          ...
          <span className="status done">{entries.length}개 공개됨</span>
        </div>
        ...
        {latestEntry ? (
          ...
          <div className="empty-inline">
            ...
            <p>튜터가 피드백을 공개하면 이곳에 성장 기록이 쌓입니다.</p>
          </div>
        )}
      ...
      <aside className="panel student-growth-panel">
        ...
        <div className="student-growth-note">
          <h3>다음에 볼 것</h3>
          <p>
            피드백에서 반복해서 등장하는 핵심 연결과 다음 과제를 확인하면, 다음
            스케치에서 무엇을 더 선명하게 표현할지 정할 수 있습니다.
          </p>
        </div>
      </aside>
    </div>
