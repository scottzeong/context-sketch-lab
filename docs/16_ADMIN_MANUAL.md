...
- Classes: 튜터가 만든 Class와 배정 학생 확인
...
관리자 Classes 화면에서는 새 Class 생성과 저장 버튼이 없습니다. 기존 Class를 삭제해야 할 때는 삭제 확인 입력칸에 `확인`을 정확히 입력한 뒤 삭제 버튼을 눌러야 합니다.

운영 중 학생 배정 데이터가 있는 Class는 삭제보다 튜터에게 정리 요청을 먼저 하는 것을 권장합니다.
